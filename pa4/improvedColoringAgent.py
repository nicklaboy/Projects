...
class ImprovedColoringAgent(ConvertToGrayscale):
    def __init__(self, k,
                 img_base_dir, img_file_name, image_dir,
        ...
        print("Running Improved K-Means++ Coloring Agent...")
        self.k = k
    ...
    def recolor_image(self):
        ...
        print("Improved K-Means++ Coloring Agent Complete")
